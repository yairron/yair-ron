...
NOISE_WORDS_EN = {
    ...
    "activity", "session", "device", "backup", "hk", "st", "fi", "ic", "db", "id",
}
NOISE_WORDS_HE = {
...
HEX_ID_RUN = re.compile(r"[0-9a-fA-F]{8,}")


def has_meaningful_word(stem: str) -> bool:
    """\u05DE\u05D6\u05D4\u05D4 \u05D0\u05DD \u05D1\u05E9\u05DD \u05D4\u05E7\u05D5\u05D1\u05E5 \u05D9\u05E9 \u05DE\u05D9\u05DC\u05D4 \u05D0\u05DE\u05D9\u05EA\u05D9\u05EA, \u05DC\u05D0 \u05E8\u05E7 \u05E8\u05E2\u05E9/\u05DE\u05D6\u05D4\u05D4 \u05D0\u05D5\u05D8\u05D5\u05DE\u05D8\u05D9.

    \u05DC\u05E4\u05E0\u05D9 \u05D7\u05D9\u05DC\u05D5\u05E5 \u05D4\u05DE\u05D9\u05DC\u05D9\u05DD, \u05DE\u05E1\u05D9\u05E8\u05D9\u05DD \u05DB\u05DC \u05E8\u05E6\u05E3 \u05E9\u05DC 8+ \u05EA\u05D5\u05D5\u05D9 \u05D4\u05E7\u05E1\u05D3\u05E6\u05D9\u05DE\u05DC \u05E8\u05E6\u05D5\u05E4\u05D9\u05DD (0-9a-f) - \u05D0\u05DC\u05D4
    \u05DB\u05DE\u05E2\u05D8 \u05EA\u05DE\u05D9\u05D3 \u05E9\u05D1\u05E8\u05D9 \u05DE\u05D6\u05D4\u05D4 \u05D8\u05DB\u05E0\u05D9 (ObjectId \u05E9\u05DC MongoDB, \u05E7\u05D8\u05E2 \u05DE-UUID, hash) \u05D5\u05DC\u05D0 \u05D8\u05E7\u05E1\u05D8
    \u05D0\u05E0\u05D5\u05E9\u05D9. \u05D1\u05DC\u05D9 \u05D4\u05E1\u05E8\u05D4 \u05DB\u05D6\u05D5, \u05DE\u05D6\u05D4\u05D9\u05DD \u05DB\u05D0\u05DC\u05D4 (\u05E9\u05DE\u05E2\u05E8\u05D1\u05D1\u05D9\u05DD \u05E1\u05E4\u05E8\u05D5\u05EA \u05D5\u05D0\u05D5\u05EA\u05D9\u05D5\u05EA) \u05DE\u05DB\u05D9\u05DC\u05D9\u05DD \u05DB\u05DE\u05E2\u05D8 \u05EA\u05DE\u05D9\u05D3
    "\u05D1\u05D8\u05E2\u05D5\u05EA" \u05E8\u05E6\u05E3 \u05E9\u05DC 2+ \u05D0\u05D5\u05EA\u05D9\u05D5\u05EA \u05E8\u05E6\u05D5\u05E4\u05D5\u05EA (\u05DC\u05DE\u05E9\u05DC "cbafb" \u05D1\u05EA\u05D5\u05DA "5258555ce4b06cbafb07180e")
    \u05E9\u05E0\u05E8\u05D0\u05D4 \u05DB\u05DE\u05D5 \u05DE\u05D9\u05DC\u05D4 \u05D0\u05DE\u05D9\u05EA\u05D9\u05EA \u05DC\u05D1\u05D5\u05D3\u05E7 \u05D4\u05EA\u05D5\u05E7\u05E0\u05D9\u05DD \u05DC\u05DE\u05E8\u05D5\u05EA \u05E9\u05D4\u05D5\u05D0 \u05E8\u05E2\u05E9 \u05D2\u05DE\u05D5\u05E8 - \u05EA\u05D5\u05E7\u05DF 17.08.2026
    \u05D0\u05D7\u05E8\u05D9 \u05E9\u05D4\u05EA\u05D2\u05DC\u05D4 \u05D1\u05E4\u05D5\u05E2\u05DC \u05E9\u05D6\u05D4 \u05D2\u05E8\u05DD \u05DC-153 \u05E7\u05D1\u05E6\u05D9\u05DD (\u05D1\u05E2\u05D9\u05E7\u05E8 \u05DE\u05D6\u05D4\u05D9 MongoDB/UUID \u05DE\u05D9\u05D9\u05D1\u05D5\u05D0 \u05D0\u05E6\u05D5\u05D5\u05D4)
    \u05DC\u05D4\u05D9\u05E9\u05D0\u05E8 \u05E2\u05DD \u05E9\u05DD \u05E7\u05E8\u05D9\u05E4\u05D8\u05D9 \u05D1\u05DE\u05E7\u05D5\u05DD \u05DC\u05D4\u05EA\u05E2\u05D3\u05DB\u05DF \u05DC\u05EA\u05D0\u05E8\u05D9\u05DA+\u05D9\u05E9\u05D5\u05D1\u05D9\u05DD. \u05E1\u05E3 8 \u05EA\u05D5\u05D5\u05D9\u05DD \u05E0\u05D1\u05D7\u05E8 \u05DB\u05D9 \u05D0\u05D9\u05DF
    \u05DE\u05D9\u05DC\u05D4 \u05D0\u05DE\u05D9\u05EA\u05D9\u05EA (\u05E2\u05D1\u05E8\u05D9\u05EA \u05D0\u05D5 \u05D0\u05E0\u05D2\u05DC\u05D9\u05EA) \u05E9\u05DE\u05D5\u05E8\u05DB\u05D1\u05EA \u05E8\u05E7 \u05DE\u05D4\u05D0\u05D5\u05EA\u05D9\u05D5\u05EA a-f \u05D1\u05D0\u05D5\u05E8\u05DA \u05DB\u05D6\u05D4."""
    stem = HEX_ID_RUN.sub(" ", stem)
