(function() {
    var CSS = `
        ...
        #btl-chat-panel {
            ...
            overflow: hidden;
            z-index: 1000;
            /* direction הוא property עם ירושה - הסרת הכלל לא מספיקה, כי העמוד עצמו
               (אתר בעברית) כנראה rtl ברמת ה-html/body, אז בלי הגדרה מפורשת כאן
               הפאנל היה יורש rtl בכל מקרה. חייבים ltr מפורש כדי שידית ה-resize
               תהיה בפינה הימנית-תחתונה - ראו גם #btl-chat-inner למטה. */
            direction: ltr;
            font-family: 'Assistant', 'Segoe UI', Tahoma, sans-serif;
        }
        #btl-chat-panel.open {
        ...
        /* direction:rtl יושב על העטיפה הפנימית ולא על #btl-chat-panel עצמו בכוונה -
           ...
           הגדרת הפאנל עצמו במפורש ל-ltr (ראו למעלה - לא מספיק רק להסיר rtl, כי
           הערך יורש מהעמוד) מבטיחה שהידית תמיד בפינה הימנית-תחתונה, בעוד התוכן
           בפנים עדיין מוצג rtl כרגיל. */
        #btl-chat-inner {
            direction: rtl;
            display: flex;
            flex-direction: column;
