    ...
    const MENU = [
        ...
        ]},
        {
            icon: '📖', text: 'מדריכים מפורטים', children: [
                ...
                { icon: '🧾', text: 'קצבת שירותים מיוחדים - שר"מ', children: [
                    { text: 'מבוא ומטרת המסמך',                    href: bp + 'senior_rights/sherutim_meiuchadim.html#intro' },
                    { text: 'מהי קצבת שירותים מיוחדים',              href: bp + 'senior_rights/sherutim_meiuchadim.html#what-is' },
                    { text: 'תנאי הזכאות',                          href: bp + 'senior_rights/sherutim_meiuchadim.html#eligibility' },
                    { text: 'רמות הקצבה והסכומים',                   href: bp + 'senior_rights/sherutim_meiuchadim.html#amounts' },
                    { text: 'השפעה הדדית מול נכות כללית',            href: bp + 'senior_rights/sherutim_meiuchadim.html#disability-interaction' },
                    { text: 'השפעה על הבטחת הכנסה',                  href: bp + 'senior_rights/sherutim_meiuchadim.html#income-support-interaction' },
                    { text: 'מגבלות וחסמים לקבלת הקצבה',              href: bp + 'senior_rights/sherutim_meiuchadim.html#limitations' },
                    { text: 'תהליך התביעה והערעור',                   href: bp + 'senior_rights/sherutim_meiuchadim.html#claim-appeal' },
                    { text: 'החמרה במצב הבריאותי/התפקודי',            href: bp + 'senior_rights/sherutim_meiuchadim.html#worsening' },
                    { text: 'הגעה לגיל פרישה / גיל פנסיה',            href: bp + 'senior_rights/sherutim_meiuchadim.html#retirement-age' },
                    { text: 'סיכום ונקודות מפתח ליועץ',               href: bp + 'senior_rights/sherutim_meiuchadim.html#summary' },
                ]},
        ...
        },
        {
            icon: '📚', text: 'סיכומים ומסמכי מידע מפורט', children: [
                { text: '🦁 דו"ח זכויות — מבצע שאגת הארי',                    href: bp + 'additional_guides/html/additional_guides_index.html#shaagat_haari' },
                { text: '⚠️ מקרים מיוחדים בגמלאות ביטוח לאומי',              href: bp + 'additional_guides/html/additional_guides_index.html#mekarim_meyuchadim' },
                { text: '🌍 אמנות בינלאומיות לביטחון סוציאלי',                href: bp + 'additional_guides/html/additional_guides_index.html#amnot_binleumiot' },
                { text: '🏠 גמלת זיקנה מיוחדת לעולים ותושבים חוזרים',        href: bp + 'additional_guides/html/additional_guides_index.html#gamlay_zikna' },
                { text: '👨‍👩‍👧 הגדרת תלויים בקצבת זקנה וקצבת שאירים',           href: bp + 'additional_guides/html/additional_guides_index.html#hagdarat_tluim' },
                { text: '🎓 דמי מחיה לשאירים בביטוח לאומי',                    href: bp + 'additional_guides/html/additional_guides_index.html#dmei_michya_leshairim' },
                { text: '💼 השלמת הכנסה וחובת ההתייצבות בשירות התעסוקה',     href: bp + 'additional_guides/html/additional_guides_index.html#chovaat_hitatzbut' },
                { text: '✈️ יציאה לחו"ל והשפעתה על קצבת זיקנה והשלמת הכנסה', href: bp + 'additional_guides/html/additional_guides_index.html#yetzia_lachul' },
                { text: '📅 תקופת אכשרה לקצבת אזרח ותיק',                     href: bp + 'additional_guides/html/additional_guides_index.html#tkufat_achshara' },
