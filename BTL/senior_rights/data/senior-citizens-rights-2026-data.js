    ...
    sections: [
        {
            ...
            contentFn: function(nii) {
                ...
                return `
                <h2 id="sc-p-ages">גילאי פרישה וזכאות</h2>

                <p><strong>גיל הפרישה לגברים:</strong> ${age('retirement_age_male')}</p>

                <h3 id="sc-p-ages-women">גיל הפרישה לנשים לפי שנת לידה</h3>
                ...
                <h3 id="sc-p-ages-absolute">גיל הזכאות המוחלט</h3>
                ...
                <h2 id="sc-p-achshara">תקופת אכשרה לנשים ולגברים</h2>
                ...
                <h3 id="sc-p-ach-insured">הגדרת "מבוטח" ותשלום דמי ביטוח</h3>
                ...
                <h3 id="sc-p-ach-periods">תקופות הנמנות כתקופת אכשרה</h3>
                ...
                <h3 id="sc-p-ach-options">התנאים לצבירת אכשרה (החלופות)</h3>
                ...
                <h3 id="sc-p-ach-exempt">פטור מתקופת אכשרה</h3>
                ...
                <h3 id="sc-p-ach-homemaker">סטטוס "עקרת בית"</h3>
                ...
                <h3 id="sc-p-ach-single">סטטוס רווקה / גרושה / אלמנה</h3>
                ...
                <h3 id="sc-p-ach-special">קצבה מיוחדת (למי שלא צבר אכשרה)</h3>
                ...
                <h3 id="sc-p-ach-age">גיל הפרישה וגיל הזכאות לקצבה</h3>
                ...
                <h3 id="sc-p-ach-checks">נקודות בדיקה חשובות</h3>
                <ol>
                ...
                <h2 id="sc-p-income-test">מבחן הכנסות</h2>
                <p>בין גיל הפרישה לגיל ${age('retirement_age_unconditional')}: קיים מבחן הכנסות מעבודה</p>

                <h3 id="sc-p-it-limits">תקרות הכנסה לשנת 2026</h3>
                ...
                <h2 id="sc-p-amounts">סכומי הקצבה הבסיסית לשנת 2026</h2>
                ...
                <h2 id="sc-p-seniority">תוספת ותק</h2>
                ...
                <h2 id="sc-p-deferral">תוספת דחיית קצבה</h2>
                ...
                <h2 id="sc-p-retro">תשלום רטרואקטיבי</h2>
                ...
                <h3 id="sc-p-retro-example">דוגמה מקיפה לחישוב קצבה</h3>
                ...
                <h2 id="sc-p-claim">הגשת תביעה לקצבת זיקנה</h2>
                <p>חודש לפני הגעה לגיל הפרישה, הביטוח הלאומי שולח באופן יזום בדואר טופס תביעה עם הפרטים האישיים (לנשים מצורף גם פירוט תקופות הביטוח שנצברו), לכתובת המעודכנת במשרד הפנים.</p>

                <h3 id="sc-p-claim-how">אופן הגשת התביעה</h3>
                <p>את התביעה ניתן להגיש בשלוש דרכים עיקריות:</p>
                <ol>
                    <li><strong>תביעה מקוונת באתר:</strong> מילוי טופס תביעה מקוון (480) באתר הביטוח הלאומי, ושליחתו בצירוף המסמכים ישירות לסניף.</li>
                    <li><strong>מילוי ידני:</strong> הורדת הטופס והדפסתו, ושליחתו בצירוף המסמכים באמצעות שירות שליחת המסמכים המקוון.</li>
                    <li><strong>הגשה פיזית:</strong> הגשת התביעה והמסמכים בדואר, בפקס, או בתיבת השירות של הסניף הקרוב למקום המגורים.</li>
                </ol>
                <p><strong>מועד הגשה:</strong> רצוי להגיש סמוך לגיל הזכאות ולא יאוחר מ-12 חודשים ממנו. מי שמגיש לאחר גיל הפרישה יכול לקבל תשלום רטרואקטיבי של עד 12 חודשים; מי שמגיש לאחר גיל 70 - עד 48 חודשי רטרואקטיבי.</p>
                <div style="background: #FFF8E1; border: 1px solid #FFE082; border-radius: 10px; padding: 14px 18px; margin: 10px 0;">
                    <p><strong>⚠️ חשוב:</strong> מי שכבר מקבלים קצבה אחרת מהביטוח הלאומי חייבים להגיש תביעה נפרדת לקצבת אזרח ותיק כשהם מגיעים לגיל הפרישה.</p>
                </div>
                <div style="background: #FFF8E1; border: 1px solid #FFE082; border-radius: 10px; padding: 14px 18px; margin: 10px 0;">
                    <p>💡 <strong>טיפ:</strong> ניתן להירשם לאתר "שירות אישי" של הביטוח הלאומי, המאפשר גם שליחת מסמכים נוספים לתביעה וגם מעקב מקוון אחר הטיפול בה בכל שלב.</p>
                </div>

                <h3 id="sc-p-claim-docs">מסמכים נדרשים לתביעה</h3>
                <p>לתביעה יש לצרף מידע על הכנסות, בהתאם למצב התעסוקתי:</p>
                <ul>
                    <li><strong>עובד שכיר:</strong> אישור מהמעסיק על סיום העבודה או צמצומה.</li>
                    <li><strong>עובד עצמאי:</strong> הצהרה על הכנסות.</li>
                    <li><strong>הכנסה אחרת:</strong> אישור על הכנסה מהשכרת נכס (חוזה שכירות), ואישור על הכנסה מריבית או מדיווידנד (אם יש).</li>
                    <li><strong>בדיקת זכאות לתוספת בן/בת זוג:</strong> יש לצרף מידע או אישורים על הכנסות בן/בת הזוג.</li>
                </ul>
                <p>מקורות נוספים (כגון מדריכי זכויות) מציינים גם צירוף תעודת זהות, אישורים על תשלומי דמי ביטוח לאומי לאורך השנים, ותלושי שכר רלוונטיים.</p>

                <h4 id="sc-p-claim-docs-income">מסמכים להשלמת הכנסה</h4>
                <p>תוספת השלמת הכנסה ניתנת למי שאין להם הכנסות נוספות מלבד הקצבה, או שהכנסתם נמוכה מסכום מסוים. יש למלא טופס תביעה ייעודי (430) ולצרף:</p>
                <ul>
                    <li>דפי חשבון בנק (עובר ושב) מ-12 החודשים האחרונים.</li>
                    <li>אישור מהבנק על פיקדונות וקופות גמל.</li>
                    <li>אישורים על הכנסות מכל מקור של התובע/ת, לרבות אישורים על נכסים ושוויים (רכוש, הון, רכב).</li>
                </ul>
                <p>ניתן להגיש את תביעת השלמת ההכנסה יחד עם תביעת קצבת אזרח ותיק, או בכל שלב מאוחר יותר כשההכנסה יורדת מתחת לסף הזכאות. גם כאן קיימת אפשרות לתשלום רטרואקטיבי של עד 12 חודשים למי שכבר מקבל את קצבת האזרח הוותיק.</p>
                <div style="background: #FFF8E1; border: 1px solid #FFE082; border-radius: 10px; padding: 14px 18px; margin: 10px 0;">
                    <p>💡 <strong>טיפ:</strong> ניתן להעלות את כל המסמכים הנ"ל - הן לתביעה הראשית והן לתביעת השלמת ההכנסה - דרך שירות שליחת המסמכים באתר האישי, במקום פקס או דואר, גם לאחר הגשת התביעה עצמה, כדי לא לעכב את מועד הזכאות.</p>
                </div>

                <h3 id="sc-p-claim-track">מעקב אחר מצב הטיפול בתביעה</h3>
                <p>התהליך הרשמי לאחר הגשת התביעה כולל ארבעה שלבים:</p>
                <ol>
                    <li><strong>מעקב והשלמת מסמכים:</strong> ייתכן שתידרשו להוסיף מסמכים נוספים לאחר ההגשה.</li>
                    <li><strong>מעקב אונליין באזור האישי:</strong> ניתן להתעדכן בכל שלב בטיפול בתביעה דרך אתר "שירות אישי".</li>
                    <li><strong>קבלת החלטה:</strong> הודעה רשמית תישלח על אישור או דחיית התביעה.</li>
                    <li><strong>תחילת תשלום:</strong> אם אושרה, הקצבה תשולם ב-28 לכל חודש ישירות לחשבון הבנק.</li>
                </ol>
                <p>באתר "שירות אישי" ניתן לראות בין היתר את מצב הטיפול בתביעה, פירוט תשלומים ששולמו, בירור נתוני ביטוח, דף חשבון, הדפסת אישורים, וצפייה במכתבים שנשלחו בשנתיים האחרונות.</p>
                <p>דרכי בירור נוספות (אם אין קוד סודי לאזור האישי): מוקד טלפוני ארצי <span dir="ltr">*6050</span> / <span dir="ltr">04-8812345</span>, צ'אט עם נציג, או פנייה ב"בירורים אישיים" באתר.</p>
                <div style="background: #FFF8E1; border: 1px solid #FFE082; border-radius: 10px; padding: 14px 18px; margin: 10px 0;">
                    <p>💡 <strong>טיפ:</strong> באתר לא מפורסם פרק זמן קבוע לטיפול בתביעה - משתנה לפי סניף ועומס. מומלץ להנפיק מראש קוד סודי לאזור האישי כדי לעקוב באופן שוטף, ולוודא הגשת כל המסמכים במלואם כדי לא לעכב את הטיפול.</p>
                </div>

                <h3 id="sc-p-claim-decision">קבלת ההחלטה על התביעה</h3>
                <p>האתר אינו מפרסם משך זמן קבוע ומדויק לקבלת ההחלטה. על פי המידע הרשמי, לאחר שלב מעקב והשלמת המסמכים תישלח הודעה רשמית על אישור או דחיית התביעה, ולאחר מכן - אם אושרה - התשלום הראשון מתבצע ב-28 לחודש.</p>
                <p>מכיוון שההחלטה תלויה בשלמות המסמכים שצורפו ובבדיקת פקיד התביעות בסניף, מומלץ:</p>
                <ul>
                    <li>לוודא שכל המסמכים צורפו במלואם עם ההגשה (או מיד לאחריה), כדי לא לעכב את הטיפול.</li>
                    <li>לעקוב אחר מצב ההחלטה ישירות באזור האישי באתר - שם מתעדכן מצב הטיפול בתביעה בזמן אמת, ולא להמתין להודעת דואר בלבד.</li>
                    <li>להתקשר למוקד הטלפוני הייעודי לאזרחים ותיקים <span dir="ltr">*9696</span> לבירור נוסף.</li>
                </ul>
                <p>אם התביעה נדחית, קיימת אפשרות להגיש ערעור על החלטת הביטוח הלאומי.</p>

                <h3 id="sc-p-claim-check">בדיקת זכאות אישית באתר</h3>
                <p>באתר קיימים מחשבוני זכאות ייעודיים לנושא אזרח ותיק (קצבת זקנה), המאפשרים לבדוק זכאות משוערת וסכום קצבה משוער.</p>
                <div style="background: #FFF8E1; border: 1px solid #FFE082; border-radius: 10px; padding: 14px 18px; margin: 10px 0;">
                    <p><strong>חשוב לדעת:</strong> הזכאות הסופית והסכום המדויק נקבעים רק לאחר הגשת תביעה בפועל, על ידי פקיד הביטוח הלאומי בסניף. נתוני המחשבון אינם נשמרים - השימוש אנונימי ולשימוש אישי בלבד.</p>
                </div>
                <div style="background: #FFF8E1; border: 1px solid #FFE082; border-radius: 10px; padding: 14px 18px; margin: 10px 0;">
                    <p>💡 <strong>טיפ:</strong> בדיקה אישית מדויקת יותר אפשרית דרך האזור האישי: מי שרשום לאתר "שירות אישי" יכול לראות נתוני ביטוח אישיים (תושבות, מעמד ביטוחי, תקופות אכשרה) שמשפיעים ישירות על הזכאות - לא רק הערכה גנרית כמו במחשבון. הכניסה לאזור האישי דורשת קוד סודי, שניתן להזמין דרך האתר במידה ואין.</p>
                </div>

                <div style="background: #E8F5E9; border: 1px solid #A5D6A7; border-radius: 10px; padding: 12px 16px; margin: 10px 0 16px 0; font-size: 0.95rem;">
                    <strong>📋 קישורים שימושיים:</strong>
                    <a href="https://www.btl.gov.il/benefits/old_age/Pages/default.aspx" target="_blank" style="color: var(--secondary); margin: 0 4px;">עמוד ראשי - אזרח ותיק (קצבת זקנה)</a> |
                    <a href="https://www.btl.gov.il/Simulators/ziknaCalc/Pages/default.aspx" target="_blank" style="color: var(--secondary); margin: 0 4px;">מחשבוני זכאות</a> |
                    <a href="https://ps.btl.gov.il/" target="_blank" style="color: var(--secondary); margin: 0 4px;">אתר שירות אישי (התחברות)</a> |
                    <a href="https://b2b.btl.gov.il/BTL.ILG.Payments/DocumentsInfo.aspx" target="_blank" style="color: var(--secondary); margin: 0 4px;">שירות שליחת מסמכים</a> |
                    <a href="https://www.btl.gov.il/snifim/Pages/default.aspx" target="_blank" style="color: var(--secondary); margin: 0 4px;">איתור סניפים</a> |
                    <a href="https://www.btl.gov.il/About/contact_us/Pages/default.aspx" target="_blank" style="color: var(--secondary); margin: 0 4px;">בירורים אישיים / יצירת קשר</a>
                </div>
            `;
            }
        },
        {
            ...
            contentFn: function(nii) {
                ...
                <h3 id="sc-is-conditions">1. תנאי זכאות בסיסיים</h3>
                ...
                <h3 id="sc-is-couple">2. זכאות זוגית: שני תרחישים מרכזיים</h3>

                <h4 id="sc-is-couple-both">א. שני בני הזוג זכאים לקצבת אזרח ותיק</h4>
                ...
                <h4 id="sc-is-couple-one">ב. רק אחד מבני הזוג זכאי לקצבת אזרח ותיק (והשני "בן זוג")</h4>
                ...
                <h3 id="sc-is-amounts">3. סכומי הקצבה (קצבת אזרח ותיק + השלמת הכנסה)</h3>
                ...
                <h3 id="sc-is-income-test">4. תקרות הכנסה וחישוב זכאות</h3>
                    <ol>
                    ...
                    <li>בודקים הכנסות קיימות:
                        ...
                        <h4 id="sc-is-imputed">💰 חישוב הכנסה רעיונית מנכסים פיננסיים</h4>
                ...
                <h3 id="sc-is-vehicle">6. בעלות על רכב</h3>
                ...
                <h3 id="sc-is-calc">7. צורת חישוב הזכאות - סיכום השלבים</h3>
                <ol>
                ...
                <h3 id="sc-is-benefits">8. הטבות נלוות לזכאים</h3>
        ...
        },
        {
            ...
            contentFn: function(nii) {
                ...
                <h3 id="sc-nu-amounts">סכומי גמלת סיעוד 2026</h3>
                <p><strong>עדכון:</strong> גמלאות סיעוד עלו ב-2.4% בינואר 2026</p>

                <h4 id="sc-nu-full">גמלה מלאה — שווי כספי</h4>
                <ul>
                ...
                <h4 id="sc-nu-half">חצי גמלה (עקב מבחן הכנסות)</h4>
                <ul>
                ...
                <h3 id="sc-nu-income-test">מבחן הכנסות</h3>
        ...
        },
        {
            ...
            content: `
                <h2 id="sc-ho-who">מי נחשב ניצול שואה?</h2>
                ...
                <h3 id="sc-ho-pensions">קצבאות מיוחדות</h3>

                <h4 id="sc-ho-supplement">תוספת לניצולי שואה לקצבת זקנה</h4>
                <ul>
                    <li><strong>תוספת חודשית:</strong> כ-4,200 ₪ (הסכום המדויק משתנה)</li>
                    <li>התוספת משולמת באופן אוטומטי למוכרים כניצולי שואה</li>
                </ul>

                <h4 id="sc-ho-rente">רנטה מגרמניה</h4>
                <ul>
        ...
        },
        {
            ...
            contentFn: function(nii) {
                ...
                <h3 id="sc-su-amounts">סכומי קצבת שארים 2026</h3>
                <p><strong>עדכון:</strong> קצבת שארים עלתה ב-2.4% בינואר 2026</p>

                <h4 id="sc-su-widow">אלמן/אלמנה</h4>
                <ul>
                ...
                <h4 id="sc-su-orphan">יתום (לכל ילד)</h4>
                <ul>
                ...
                <h4 id="sc-su-family">תוספת למשפחה</h4>
                <ul>
        ...
        },
        {
            ...
            title: "הטבות נוספות",
            content: `
                <h2 id="sc-be-arnona">הנחות בארנונה</h2>
                <ul>
                ...
                <h2 id="sc-be-tax">הנחות במס הכנסה</h2>
                ...
                <h2 id="sc-be-transport">הנחות בתחבורה ציבורית</h2>
                <ul>
                ...
                <h2 id="sc-be-culture">הנחות בתרבות ונופש</h2>
                <ul>
                ...
                <h2 id="sc-be-health">שירותי בריאות</h2>
                <ul>
                ...
                <h2 id="sc-be-social">שירותים חברתיים</h2>
                <ul>
        ...
        },
        {
            ...
            content: `
                <h2 id="sc-co-btl">המוסד לביטוח לאומי</h2>
                <ul>
                ...
                <h3 id="sc-co-hotlines">מוקדים ייעודיים</h3>
                <ul>
                ...
                <h2 id="sc-co-summary">סיכום והערות חשובות</h2>
                <ul>
