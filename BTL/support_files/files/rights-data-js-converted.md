# המרת קובץ rights-data.js

**תיאור:** קובץ זה הוא תוצר המרה של הקובץ `BTL/senior_rights/data/rights-data.js`.
הוא מכיל את כל המידע על זכויות אזרחים ותיקים בפורמט Markdown, תוך שמירה על מבנה ה-HTML המקורי לצורך תצוגה.
**תאריך יצירה:** 2024-07-25

---

# קצבאות זקנה וזכויות ביטוח לאומי
       <a href="https://www.kolzchut.org.il/he/%D7%96%D7%9B%D7%95%D7%AA%D7%95%D7%9F_%D7%A7%D7%A6%D7%91%D7%AA_%D7%96%D7%99%D7%A7%D7%A0%D7%94" target="_blank" class="link-item">🏛️  זכותון קצבת זיקנה - כל זכות. כל המידע על קצבת זיקנה במקום אחד</a>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tbody>
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪10,113-₪14,402</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">מעל ₪14,402</td>
            </tr>
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪13,484-₪20,082</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">מעל ₪20,082</td>
            </tr>
          </tbody>
        </table>
        ...
        <div style="background: #fff8e1; padding: 20px; border-radius: 10px; margin: 15px 0;">
          ...
          <ul>
            ...
            <li><strong>מצב:</strong> הכנסה בטווח הזכאות לקצבה חלקית (₪10,113 - ₪14,402)</li>
          </ul>
        ...
        <div style="background: #e3f2fd; padding: 20px; border-radius: 10px; margin: 15px 0;">
          ...
          <ul>
            ...
            <li><strong>הכנסה משפחתית כוללת: ₪15,500</strong> (בטווח ₪13,484-₪20,082)</li>
          </ul>
        ...
        <div style="background: #fce4ec; padding: 20px; border-radius: 10px; margin: 15px 0;">
          ...
          <div style="background: #fff3e0; padding: 15px; border-radius: 8px; border-right: 4px solid #ff9800; margin: 15px 0;">
            <p><strong>⚠ שימו לב:</strong> במקרה זה, הכנסת בן/בת הזוג שטרם הגיע לגיל פרישה נכללת במבחן ההכנסות. מכיוון שההכנסה המשפחתית (₪18,500) נמוכה מהתקרה המבטלת זכאות (₪20,082), אברהם זכאי לקצבה חלקית.</p>
          </div>
        ...
        <div style="background: #f0f8ff; padding: 20px; border-radius: 10px; border-right: 4px solid #667eea;">
          ...
          <ul>
            ...
            <li>ביניים: ₪2,757</li>
            <li>תוספת דחייה (15%): ₪414</li>
            <li><strong>סה"כ קצבה: ₪3,171 לחודש</strong></li>
          </ul>
        ...
        <div style="background: #e8f5e9; padding: 15px; border-radius: 8px; margin: 15px 0;">
          ...
          <ul>
            ...
            <li><strong>סה"כ הכנסה: ₪10,864</strong></li>
          </ul>
        </div>
...
# גמלת נכות כללית וקצבת שירותים מיוחדים
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tbody>
            <tr><td style="padding: 10px; border: 1px solid #ddd;">מלאה (100% / 75%)</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center; font-weight: bold;">₪4,711</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪1,518</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪1,214</td></tr>
            <tr><td style="padding: 10px; border: 1px solid #ddd;">חלקית 74%</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center; font-weight: bold;">₪3,211</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪1,123</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪898</td></tr>
            <tr><td style="padding: 10px; border: 1px solid #ddd;">חלקית 65%</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center; font-weight: bold;">₪2,894</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪987</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪789</td></tr>
            <tr><td style="padding: 10px; border: 1px solid #ddd;">חלקית 60%</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center; font-weight: bold;">₪2,718</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪911</td><td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪728</td></tr>
          </tbody>
        </table>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪2,413</td>
            ...
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪4,102</td>
            ...
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪5,066</td>
            ...
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪6,273</td>
            ...
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪7,238</td>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tbody>
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">עד ₪13,467</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪13,467–₪20,201</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">מעל ₪20,201</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd; font-weight: bold;">זוג</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">עד ₪20,201</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">₪20,201–₪30,301</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">מעל ₪30,301</td>
            </tr>
          </tbody>
        </table>
      ...
      <h2 class="no-accordion">🕯️ זכויות ניצולי שואה - מדריך מקיף 2026</h2>
        ...
        <div style="background: #e8f5e9; padding: 20px; border-radius: 10px; margin: 20px 0;">
          ...
          <ul>
            ...
            <li><strong>תשלום בכסף:</strong> ₪2,169 לחודש (רק למי שמקבל גמלה בכסף מהביטוח הלאומי)</li>
          </ul>
        </div>
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tbody>
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd;">סיוע כספי ₪1,500 לחודש</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;">6 נקודות + גמלה מופחתת</td>
              <td style="padding: 10px; border: 1px solid #ddd;">סיוע כספי ₪963 לחודש</td>
            </tr>
            <tr>
              <td style="padding: 10px; border: 1px solid #ddd;">1.5-2 נקודות (לא זכאים לסיעוד)</td>
              <td style="padding: 10px; border: 1px solid #ddd;">סיוע כספי ₪428 לחודש</td>
            </tr>
          </tbody>
        </table>
        <p><small>הערה: שוויה של שעת סיעוד שבועית אחת הוא ₪241 בחודש</small></p>
...
# תקציר - השפעות הדדיות בין ההטבות
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd;">רמה 1: ₪1,659<br>רמה 6: ₪7,238<br>או שעות טיפול</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">לא</td>
            ...
            <tr>
              ...
              <td style="padding: 10px; border: 1px solid #ddd;">100%: ₪4,711<br>+ תוספת בן זוג</td>
              <td style="padding: 10px; border: 1px solid #ddd; text-align: center;">כן</td>
...
# מענקים ותשלומים מיוחדים
        ...
        <div style="background: #fff8e1; padding: 20px; border-radius: 10px; border-right: 4px solid #ff9800; margin: 20px 0;">
          ...
          <ul>
            <li><strong>הכנסה מעבודה</strong> - כשכיר או עצמאי (עם הפחתה של ₪2,093)</li>
            <li><strong>פנסיה</strong> - מכל מקור (עם הפחתה של ₪2,093)</li>
            <li><strong>קופת גמל</strong> - תשלום חודשי (עם הפחתה של ₪2,093)</li>
        ...
        <h5>קצבת יתומים:</h5>
        <ul>
          <li><strong>השלמת הכנסה ליתומים משני הורים: ₪2,434</strong> לכל ילד (נכון ל-1.1.2026)</li>
        ...
        <ul>
          ...
          <li>אם להורה לא משולמת קצבת שאירים - דמי מחיה: <strong>₪946</strong></li>
